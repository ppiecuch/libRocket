...
extern void RenderGrid(int main_window_width, int main_window_height, float scale, int rows, int columns, int subdivs, bool bg);
...
public:
    ...
    QDRuler(QDRuler::RulerType rulerType, QWidget* parent = NULL) : QWidget(parent), mRulerType(rulerType), mOrigin(0.), mRulerUnit(1.),
...
class RenderingView : public QOpenGLWidget
{
    Q_OBJECT
